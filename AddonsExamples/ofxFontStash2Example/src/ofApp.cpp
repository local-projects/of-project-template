...
//	string formattedText = "<style font=veraMono size=20 color=#ff0000>this is: red! veramono 12 this is: red! veramono 12</style> ";
	string formattedText = "<style id='banana'>this is banana style. 槊監しゅ祟䤂לרפובליקה. אם מיזם 銆銌 憉 圩芰敔 तकनिकल कार्यलय.</style>";
...
//	ofDrawRectangle(50, 0, 200, 100);
	...
	TS_START("drawColumn");
	fonts.drawColumn("aaa bbbbbbbbfds\nfdjhskfjhds kjfhdsl", style, mouseX, mouseY + 300, 100);
	TS_STOP("drawColumn");
